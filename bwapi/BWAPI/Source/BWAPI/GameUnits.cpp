...
namespace BWAPI
{
  ...
  {
    // sb-perf: BOT_MIRROR_SEQ=1 defers the per-unit fingerprint build (updateInternalData) out of
    ...
    // sb-perf mirror sequential pass (BOT_MIRROR_SEQ): build every alive unit's fingerprint in
