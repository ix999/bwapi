...
namespace BWAPI
{
  ...
  {
    // sb-perf: GLITCH_MIRROR_SEQ=1 defers the per-unit fingerprint build (updateInternalData) out of
    ...
    // sb-perf mirror sequential pass (GLITCH_MIRROR_SEQ): build every alive unit's fingerprint in
