...
namespace BWAPI
{
  ...
  bool UnitImpl::mirrorSeqEnabled()
  {
    static const bool seq = [] {
      const char* v = std::getenv("BOT_MIRROR_SEQ");
      return v && *v && std::strcmp(v, "0") != 0;
    }();
    return seq;
  }
  ...
  bool UnitImpl::mirrorSnapRelocEnabled()
  {
    static const bool reloc = [] {
      const char* v = std::getenv("BOT_MIRROR_SNAP_RELOC");
      return v && *v && std::strcmp(v, "0") != 0;
    }();
    return reloc;
  }
  ...
  bool UnitImpl::mirrorPrefetchEnabled()
  {
    static const bool pf = [] {
      const char* v = std::getenv("BOT_MIRROR_PREFETCH");
      return v && *v && std::strcmp(v, "0") != 0;
    }();
    return pf;
  }
  ...
  int UnitImpl::mirrorPrefetchHint()
  {
    ...
    static const int hint = [] {
      const char* v = std::getenv("BOT_MIRROR_PREFETCH_HINT");
      if (v) {
  ...
  void UnitImpl::updateInternalData()
  {
    ...
    if (isAlive && mirrorSkipEligible(o))
    {
      ...
      // Software prefetch (latency lever, BOT_MIRROR_PREFETCH): `snap` is the memcmp's cold
